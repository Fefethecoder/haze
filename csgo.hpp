...
// 2021-03-30 04:56:36.128972200 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1617080196;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwClientState_Map = 0x5DE58B16;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2CAAE320;
